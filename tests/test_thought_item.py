...
class TestThoughtItem(unittest.TestCase):
    ...
    def test_create_thought_item(self):
        ...
        self.assertEqual(retrieved.item_type, ItemType.THOUGHT, "Item type should be THOUGHT")
        self.assertEqual(retrieved.item_type.value, "th", "Item type value should be 'th'")
    ...
    def test_add_thought_via_worksystem(self):
        ...
        self.assertEqual(thought.item_type, ItemType.THOUGHT, "Item type should be THOUGHT")
        ...
        self.assertIsNotNone(retrieved, "Thought item should be retrievable from database")
        self.assertEqual(retrieved.item_type, ItemType.THOUGHT, "Retrieved item type should be THOUGHT")
    ...
    def test_filter_thoughts(self):
        ...
        self.assertEqual(thoughts[0].item_type, ItemType.THOUGHT, "Item type should be THOUGHT")
        
        # Verify filtering via WorkSystem also works
        ws_thoughts = self.work_system.get_items_by_type(ItemType.THOUGHT)
        self.assertEqual(len(ws_thoughts), 1, "WorkSystem should find exactly one thought item")
